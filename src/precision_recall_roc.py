...
def generate_precision_recall_auc_graphs(
    y_true, y_predict, version, show_threshold=False
):
    """
...
if __name__ == "__main__":
    ...
    generate_precision_recall_auc_graphs(
        y_true_example, y_predict_example, version="test_v1"
    )
